...
typ="h"; col="blue"; lwd=6; 
plot(date,dc, type=typ,col=col,lwd=lwd, main=plotTitle1,xlab=xlab,ylab="Digits Count")
...
#(i) and (for presidents since Franklin Roosevelt in 1932) whether they seem to differ between Republican and
#Democratic presidents 
# Your response here does not have to be extensive.

#(j) Extra credit: Do some additional research and/or additional thinking to come up with additional
